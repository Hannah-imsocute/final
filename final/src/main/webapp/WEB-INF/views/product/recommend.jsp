...
<body>
 ...
 <!-- 메인 패널 -->
	        <div class="main-panel">
	            <h5 class="main-top-name">당신을 위한 추천작이에요!</h5>
	           <br>
				<div class="searchForm" style="display: flex; justify-content: flex-end; width: 100%;">
					<div class="col-6 text-center">
						<form class="row" name="searchForm">
							...
							<div class="col-auto p-1">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/product/recommendMain" title="새로고침" style="background: orange;"><i class="bi bi-arrow-counterclockwise"></i></button>
							</div>
						</form>
					</div>
				</div>
