...
<body>
  ...
  <main style="margin-top: 200px;">
    ...
    <section class="best-items-section">
            ...
            <div class="col-5-custom">
              <div class="best-item" onclick="location.href='${pageContext.request.contextPath}/product/${dto.productCode}'">
                ...
                <button class="heart-btn">
                  <i class="bi ${dto.liked == 'unliked' ? 'bi-heart' : 'bi-heart-fill'}"></i>
                </button>
              </div>
            </div>
          </c:forEach>
      ...
      <!-- 작품 더보기 버튼 -->
      <button type="button" class="more-btn" onclick="location.href='${pageContext.request.contextPath}/product/popular'">작품 더보기</button>
    </section>
  </main>
  <footer>
