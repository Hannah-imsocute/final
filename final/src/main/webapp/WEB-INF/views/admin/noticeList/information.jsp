...
<body>
	...
	<main class="main-container">
		...
		<ul class="nav nav-tabs mb-4">
			<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/admin/notice/main">공지사항</a></li>
			<li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/admin/notice/info">문의사항</a></li>
			...
			<table class="table table-striped align-middle">
				<thead>
					<tr>
						...
						<th scope="col" style="width: 20%;">문의날짜</th>
						<th scope="col" style="width: 20%;">처리유무</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="dto" items="${list}" varStatus="status">
						<tr>
							...
							<td>${dto.answerstate == 0 ? '답변필요' : '답변완료'}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
			...
			$('.search-btn')
					.click(
							function() {
								...
								let url = '${pageContext.request.contextPath}/admin/notice/info?kwd='
