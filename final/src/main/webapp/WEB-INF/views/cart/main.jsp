...
<head>
    ...
    <!-- 헤더를 fixed에서 일반 흐름으로 변경 (override) -->
    <style>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body {
            ...
            color: #333;
            /* 헤더가 고정되지 않으므로 별도의 padding-top은 필요 없음 */
        }
        main { margin-top: 0; }
    ...
    <div class="cart-container">
        ...
        <div class="cart-content">
            ...
            <div class="cart-summary">
                ...
                <button type="button" class="btn-order" onclick="location.href='${pageContext.request.contextPath}/order/form'">
