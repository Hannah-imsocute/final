...
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/layout/admin.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/dist/vendor/bootstrap5/js/bootstrap.min.js"></script>